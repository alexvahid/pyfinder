...
python3_2_3 = '/app/pyenv323/versions/3.2.3/bin/python'
pyexz3 = "../pyexz3.py"
...
def index(request):
    ...
    if request.method == 'POST':
        ...
        file_path = BASE_DIR + "/" + test_suites + 'temp_file_test_suite.py'
        ...
        encoded = base64.b64encode(open(BASE_DIR + "/temp_file.png", "rb").read()).decode("utf-8")
